# Checklist chạy thử thứ Hai (Monday Pilot Checklist)

ĐẠT (PASS) nếu người dùng có thể thực hiện thành công các bước sau:
- [ ] Mở giao diện ứng dụng bằng tệp lệnh `RUN_AIOS_CASE_COCKPIT.bat`.
- [ ] Tạo một hồ sơ sự việc (case) thực tế lưu cục bộ.
- [ ] Nạp thành công bằng chứng là bảng tính Excel hoặc dữ liệu CSV.
- [ ] Nạp thành công hình ảnh bằng chứng (ảnh chụp màn hình hoặc tệp log dạng ảnh).
- [ ] Dán thành công đoạn hội thoại chat hoặc log hệ thống dạng văn bản.
