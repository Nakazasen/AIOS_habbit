...
## 11. Mốc 6 — Cảnh báo Realtime, Email biểu đồ chuẩn Nhật và Phân cấp Zero-UI (US12)
...
- [ ] T066 [US12] Kiểm toán toàn diện US12, quét ngôn ngữ tiếng Việt 100% và chạy cổng chất lượng dự án
  - Chạy `compileall`, toàn bộ `pytest -q`, `cli audit`, import `workspace_chat_app`.
  - Quét tiếng Việt trên toàn bộ tin nhắn, thẻ phân tích, mẫu email và giao diện text.
  - Đóng Mốc 6 với trạng thái `TECHNICAL_PASS` có thể tái hiện trên Python 3.11.
