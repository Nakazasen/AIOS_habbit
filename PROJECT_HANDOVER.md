...
- **Feature 010 — AI phỏng vấn chuyên gia:** `READY_TO_RUN`, chưa có code. [Bộ kế hoạch](specs/010-expert-knowledge-acquisition/plan.md) gồm 81 task/G0–G10 và [prompt Gemini Flash 3.8](specs/010-expert-knowledge-acquisition/GEMINI_FLASH_3_8_GOAL.md). Sáu mặc định đã khóa; Goal kỹ thuật tự chạy bằng fixture và audit agent tách biệt, không chờ người quyết định phase. Multi-user/audio thật giữ tắt tới khi runtime có môi trường phù hợp; fine-tune luôn `NOT_APPLICABLE` trong feature 010.
