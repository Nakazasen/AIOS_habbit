...
- **Hồ sơ vụ Workspace Chat (Cổng 1, 2026-08-30):** Đã PASS audit phạm vi. Nút lưu hồ sơ dùng kho SQLite cục bộ `local_cases/workspace_cases.sqlite`, tách khỏi thư viện chữ và kho log. Record chỉ giữ định danh cuộc trò chuyện/trace cùng tham chiếu bằng chứng; không sao chép hội thoại hay excerpt nguồn. Trace có bất kỳ node nào thiếu/khác nhãn `local_only` bị từ chối; bấm lưu lặp lại cùng trace chỉ trả về một hồ sơ; kết nối SQLite được đóng sau thao tác. Việc này chưa mở luồng chuyên gia, bài học, pilot line, dự đoán LSU hoặc agent thực thi.
