...
| Trợ lý thực thi công việc cho kỹ sư (009) | `ACTIVE`: G1 `PARTIAL` (OpenCode đọc–sửa–test được; thiếu undo sạch → hoãn US3). **Không BLOCKED.** Việc tiếp: T011 US1 rồi US2, không cần OpenCode. |
