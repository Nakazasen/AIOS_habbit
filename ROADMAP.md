...
| Trợ lý thực thi công việc cho kỹ sư (009) | `ACTIVE`: 2026-09-13 khóa sản phẩm = trợ lý việc hằng ngày (cảm giác Grokbot, local), **cấm over-engineer**. US1 = file báo cáo dùng được. Hợp đồng + prompt Gemini đã có. G1 chưa probe OpenCode. |
