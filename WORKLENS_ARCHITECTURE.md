...
Tài liệu này là tóm tắt boundary kiến trúc hiện hành. Detailed runtime views,
ADRs, privacy/security controls và operational contracts nằm trong
[Professionalization Index](docs/PROFESSIONALIZATION_INDEX.md), đặc biệt:

- [Containers](docs/architecture/CONTAINERS.md) và
  [components](docs/architecture/COMPONENTS.md);
- [Architecture Decision Records](docs/adr/README.md);
- [Threat model](docs/security/THREAT_MODEL.md);
- [Runtime interface contracts](docs/contracts/RUNTIME_INTERFACES.md).

`ROADMAP.md` vẫn là nguồn trạng thái delivery canonical duy nhất.
