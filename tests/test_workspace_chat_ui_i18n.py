...
class TestWorkspaceChatUIAntiHardcode:
    ...
    def test_new_translation_keys_parity_and_non_empty(self) -> None:
        ...
        new_keys = [
            ...
            "local_work_tools_title",
            "local_work_tools_intro",
            "local_work_tools_ready_sources",
            "local_work_tools_need_source",
            "local_work_tools_error_summary",
            "local_work_tools_error_preparation",
            "local_work_tools_review_summary",
            "local_work_tools_review_preparation",
            "agent_factory_error_create_failed",
            "agent_process_review_create_failed",
            "agent_queue_heading",
            "agent_queue_caption",
            "agent_queue_empty",
            "agent_queue_status_queued",
            "agent_queue_status_running",
            "agent_queue_status_completed",
            "agent_queue_status_cancelled",
            "agent_queue_status_failed",
            "agent_queue_status_interrupted",
            "agent_queue_type_error_report",
            "agent_queue_type_process_review",
            "agent_queue_type_code_change",
            "agent_queue_item_meta",
            "agent_queue_status_prefix",
            "agent_queue_btn_cancel",
            "agent_queue_cancel_success",
            "agent_queue_btn_open",
            "agent_queue_btn_undo",
