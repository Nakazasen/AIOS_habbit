...
## UI behavior
The owner section is labeled "Cầu nối model mạnh qua Antigravity" and provides buttons to create the bundle, check Antigravity response, and save the validated strong answer. The raw JSON path input remains inside a manual fallback expander, not the default path.
